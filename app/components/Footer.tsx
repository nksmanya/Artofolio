      ...
      <div className="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <ul className="text-gray-300 text-sm mt-2 space-y-1">
            <li><a className="hover:text-white" href="mailto:nksmanya@gmail.com">Email</a></li>
        ...
        <div>
          ...
          <ul className="text-gray-300 text-sm mt-2 space-y-1">
            ...
            <li><a className="hover:text-white" href="#latest">Gallery</a></li>
            <li><a className="hover:text-white" href="https://nksmanya.vercel.app" target="_blank" rel="noreferrer">My Website </a></li>
